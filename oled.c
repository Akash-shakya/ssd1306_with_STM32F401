...
#define SSD1306_NORMALDISPLAY       0xA4		//  0 FOR NORMAL DISPLAY
#define SSD1306_INVERTDISPLAY       0xA7		//  1 FOR INVERT DISPLAY
...
/*********************************DISPLAY COLOUR CHANGE - BLACK AND WHITE *******************************************/
void SSD1306_InvertDisplay (int i)
{
  if (i==1) SSD1306_WRITECOMMAND (SSD1306_INVERTDISPLAY);
...
void drawRectangle(int x0, int y0, int x1, int y1, bool color) {
    drawLine(x0, y0, x1, y0, color); // Top edge
    drawLine(x0, y1, x1, y1, color); // Bottom edge
    drawLine(x0, y0, x0, y1, color); // Left edge
    drawLine(x1, y0, x1, y1, color); // Right edge
}
